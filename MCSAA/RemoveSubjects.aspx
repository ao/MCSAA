<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RemoveSubjects.aspx.vb" Inherits="MCSAA.RemoveSubjects" %>
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="4">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Remove Subjects"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                            ...
                            <table class="auto-style1">
                                <tr>
                                    <td>
                                        ...
                                        <asp:SqlDataSource ID="SDSSubject" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [SubjectName], [Credit], [SubjectCode] FROM [tbSubject]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
