<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PublishTimetables.aspx.vb" Inherits="MCSAA.PublishTimetables" %>
...
<body style="width: 492px; height: 400px">
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="4">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Publish Timetables"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="4" rowspan="8">
                        <asp:Panel ID="pRelevantSubjects" runat="server" GroupingText="Relevant Subjects" Height="168px" ScrollBars="Auto">
                            <table class="auto-style1">
                                <tr>
                                    <td>
                                        <asp:GridView ID="gvSubjects" runat="server" AutoGenerateColumns="False" DataSourceID="SDSSubject" ShowHeaderWhenEmpty="True" Width="420px">
                                            <Columns>
                                        ...
                                        <asp:SqlDataSource ID="SDSSubject" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Day], [SubjectName], [CourseName], [Code], [CTime] FROM [tbTimeTable]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;</td>
                    <td>
                    <asp:Button ID="btEditTimetable" runat="server" Text="Edit Timetable" Width="163px" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
