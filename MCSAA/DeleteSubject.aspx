<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeleteSubject.aspx.vb" Inherits="MCSAA.DeleteSubject" %>
...
<body style="width: 524px; height: 414px">
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="4">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Delete Subject"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="3">
                        <asp:RadioButton ID="rbkeep" runat="server" Text="Delete and keep current assignments" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="3">
                        <asp:RadioButton ID="rbremove" runat="server" Text="Delete and remove all assignments" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                    <asp:Button ID="btSave" runat="server" Text="Delete" Width="70px" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
