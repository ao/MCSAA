<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LonginSelection.aspx.vb" Inherits="MCSAA.LonginSelection" %>
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="4">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="User Type"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <asp:RadioButtonList ID="rblUserType" runat="server">
                            <asp:ListItem>Guest User</asp:ListItem>
