<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreateNewSubjectList.aspx.vb" Inherits="MCSAA.CreateNewSubjectList" %>
...
<body style="width: 519px; height: 397px">
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="4">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Create New Subject List"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4" rowspan="8">
                        <asp:Panel ID="pRelevantSubjects" runat="server" GroupingText="Use Subject code to add subject to list" Height="168px" ScrollBars="Auto">
                            <table class="auto-style1">
                                <tr>
                                    <td>
                ...
                <tr>
                    ...
                    <td colspan="3">&nbsp;</td>
                    <td>
                        <asp:Button ID="btAdd" runat="server" Text="Add" Width="54px" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
